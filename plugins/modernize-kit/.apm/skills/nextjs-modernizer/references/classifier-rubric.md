...
- Examples: `BC-103` (Client Router Cache `staleTime` default flip), `BC-401` (React 19 peer bump).
...
- Examples: `BC-201` (`experimental.bundlePagesExternals` → `bundlePagesRouterDependencies`), `BC-203` (`'experimental-edge'` → `'edge'`).
